...
export const metadata: Metadata = {
  title: "Blog — Next Health Band",
  description: "Sağlık ve teknoloji hakkında güncel yazılar.",
};
      ...
      <section className="py-24 bg-bg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <FadeIn className="text-center mb-16">
            ...
            <p className="text-muted mt-3">Sağlık ve teknoloji hakkında güncel yazılar</p>
          </FadeIn>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {posts.map((post, i) => (
                <FadeIn key={post.id} delay={i * 0.05}>
                  <Link href={`/tr/blog/${post.slug}`} className="group block h-full">
